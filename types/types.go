// Package types contains shared profiling parameter types used by the
// profiling subpackages.
package types

// Parameters are common profiling parameters shared across profiler backends.
